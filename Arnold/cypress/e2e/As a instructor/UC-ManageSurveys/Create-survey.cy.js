describe("Survey Management", () => {
  it("should successfully Create-surveys", () => {
    ...
    // Open User menu
    cy.contains("User").should("be.visible").click();
    ...
    cy.get('[name="log"]').should("be.visible").clear().type("Leonce");
    ...
    cy.get('[name="rememberme"]').should("exist").check({ force: true });

    // Submit login form
    cy.get('[name="wp-submit"]').should("be.visible").click();
    ...
    cy.get('.page-title-action').should("be.visible").click();
    ...
    // Click Save button
    cy.get('#save-action > [name="save"]').should("be.visible").click();
    ...
    cy.get('[name="publish"]').should("be.visible").click();
